	...
	<div class="cavani_tm_all_wrap" data-magic-cursor="show" data-enter="bounceIn" data-exit=""> 	
		...
		<div class="cavani_tm_mobile_menu">
			<div class="inner">
				<div class="wrapper">
					<div class="avatar">
						<div class="image" data-img-url="{{ asset('frontend_assets') }}/img/about/3.jpg"></div>
					</div>
					<div class="menu_list">
						<ul class="transition_link">
							<li class="active"><a href="#home">Home</a></li>
					...
					<div class="social">
						<ul>
							...
							<li><a href="#"><img class="svg" src="{{ asset('frontend_assets') }}/img/svg/social/instagram.svg" alt="" /></a></li>
							<li><a href="#"><img class="svg" src="{{ asset('frontend_assets') }}/img/svg/social/dribbble.svg" alt="" /></a></li>
							<li><a href="#"><img class="svg" src="{{ asset('frontend_assets') }}/img/svg/social/tik-tok.svg" alt="" /></a></li>
						</ul>
					</div>
					<div class="copyright">
